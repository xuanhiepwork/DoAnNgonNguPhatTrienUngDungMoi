...
router.get('/my-stats', verifyToken, async (req, res) => {
    ...
    try {
        ...
        const [payroll] = await pool.query('SELECT IFNULL(net_salary, 0) as net_salary FROM payroll WHERE employee_id = ? ORDER BY year DESC, month DESC LIMIT 1', [empId]);
        ...
        console.error("Lỗi Dashboard Nhân viên:", error);
